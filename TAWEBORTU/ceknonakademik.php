  ...
  <div id="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Nilai Nonakademik</li>
      </ol>
      <div class="card mb-3">
        <form method="GET" action="nonakademik.php">
          <div class="card-header">
            ...
            <table>
              <tr>
                <td style="width: 300px;">Nama siswa</td>
                ...
                <td style="width: 300px;">
                  ...
                  while($row = mysqli_fetch_array($result)){
                      ...
                      echo "<input type='hidden' name='kelas' value='".$row['Nama_Kelas']."'>";
                    }
                    ?>
                  </td>
                </tr>
