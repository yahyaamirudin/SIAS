   ...
   <div id="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Nilai non akademik</li>
      </ol>
      <div class="card mb-3">
        <div class="card-header">
          <table>
            <form action="daftarsiswanon.php" method ="GET">
            <!--   <tr>
                <td style="width: 300px;">Guru/Walikelas</td>
                <td style="width: 300px;">:</td>
                <td>
                  <select name="tendik" class="custom-select custom-select mb-3">
                    <?php  
                    // $qkelas = mysqli_query($konek,"SELECT * FROM `guru`join`kelas` on guru.NIP=kelas.NIP");
