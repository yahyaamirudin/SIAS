    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          $sql2 = "SELECT Distinct Nama_Kelas,nama,Semester FROM nilai_siswa WHERE Nama_Kelas='$kelas' and nama = '$nama' and Semester = '$smt' and tahun_awal = '$awal' and tahun_akhir='$akhir'";
