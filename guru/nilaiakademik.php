              ...
              <tr>
                ...
                <td style="width: 300px;">
                 <select name="pelajaran" class="custom-select custom-select mb-3">
                  <?php  
                 $qmapel = mysqli_query($konek,"SELECT * FROM `mapel` join `jadwal_pelajaran` on mapel.ID_mapel = jadwal_pelajaran.ID_mapel join guru on guru.nama_guru=jadwal_pelajaran.Guru where nama_guru='".$_SESSION['nama']."'");
